...
[#adjustment] DBA: **Adjustment**; model: `Adjustment`
...
[#canonical-item] DBA: **Canonical Item**
...
[#diaper-drive] DBA: **Diaper Drive**; model: `DiaperDriveParticipant`
NDBN: **diaper drive**
...
[#donation] DBA: **Donation**; model: `Donation`
...
[#donation-site] DBA: **Donation Site**; model: `DonationSite`
...
[#inventory-item] DBA: **Inventory Item**; model: `InventoryItem`
...
[#line-item] DBA: **Line Item**; model: `LineItem`
...
[#organization] DBA: **Organization**; model: `Organization`
NDBN: **diaper bank**
  The software abstraction of a diaper bank, and used interchangeably as a term.

[#partner] DBA: **Partner**
NDBN: **Community Partner**, **Partner Organization**
...
[#purchase] DBA: **Purchase**; model: `Purchase`
...
[#request] DBA: **Request**; model: `Request`
...
[#storage-location] DBA: **Storage Location**; model: `StorageLocation`
...
[#transfer] DBA: **Transfer**; model: `Transfer`
